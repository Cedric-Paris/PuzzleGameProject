...
/// <summary>
/// The RightArrowUIDraggableElement is a <see cref="UIDraggableElement"/>. Its use is to specify which elements are bound to the <see cref="UIDraggableElement"/> for the Right Arrow.
/// </summary>
